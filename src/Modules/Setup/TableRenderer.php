...
use Sintattica\Atk\Core\Tools;
  ...
  class TableRenderer
  {
     ...
     */
    function TableRenderer($flags = 0, $style='', $module='')
    {
      $this->m_flags = $flags;
    ...
    function _getRowClassStr($row)
    {
      ...
      else if (Tools::hasFlag($this->m_flags, TBL_ALTERNATE) && ($row % 2) !== 0)
      {
        return 'class="row2"';
      }
      else
    ...
    {
      $ret='';
      if(Tools::hasFlag($alignment,TBL_LEFT)) $ret.='align="left" ';
      elseif(Tools::hasFlag($alignment,TBL_RIGHT)) $ret.='align="right" ';
      elseif(Tools::hasFlag($alignment,TBL_CENTER)) $ret.='align="center" ';

      if(Tools::hasFlag($alignment,TBL_TOP)) $ret.='valign="top" ';
      elseif(Tools::hasFlag($alignment,TBL_BOTTOM)) $ret.='valign="bottom" ';
      elseif(Tools::hasFlag($alignment,TBL_MIDDLE)) $ret.='valign="middle" ';
